    ...
    <div style="text-align: center; margin-left: 5%; margin-right: 5%;">
        <form action="../PHP/creategroup.php" method="POST" enctype="multipart/form-data">
            <div class="container mt-3 cont1">
                ...
                <input type="text" placeholder="Cool name here!" name="group_name">
                <br>
                <br>
                ...
                <br>
                <textarea cols="80" rows="5" placeholder="Describe your group in an appealing way!" name="group_description"></textarea>
                <br>
                <br>

                <button class="btn btn-primary" type="submit" id="create" name="create">Create Group</button>
            </div>
        </form>
    </div>
