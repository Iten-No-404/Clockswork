...
<body>
    <?php   $_SESSION['app_id']=$_GET['id'];?>
    <h1>Edit Your Apps</h1>
  
    <div style="text-align: center; margin-left: 5%; margin-right: 5%;">
        <form action="../PHP/editapp.php" method="POST" enctype="multipart/form-data">
            <div class="container mt-3 cont1">
                <label>Name:</label>
                <input type="text" placeholder="MyApplication"  value="<?php
                          $obj=new App(); $x=$obj->getname($_SESSION['app_id']); echo$x;?>"
                ...
                <input type="url" id="application-link" value="<?php
                          $obj=new App(); $x=$obj->getApplication_Link2($_SESSION['app_id']); echo$x;?>" name="application-link">
                <h6 id="app-link"></h6>
                ...
                <textarea cols="80" rows="5"
                    placeholder="Describe your application in a great way to attract people." id="app-description"
                    name="app-description" value=""> <?php
                          $obj=new App(); $x=$obj->getAppDescription($_SESSION['app_id']); echo$x;?></textarea>
                <h6></h6>
                <label>System Requirements:</label>
                <h6></h6>
                <textarea cols="80" rows="5"
                    placeholder="Describe your application's minimum and preferred requirements." id="system-requirements"
                    name="system-requirements">
                    <?php
                          $obj=new App(); $x=$obj->getSystem_Requirements($_SESSION['app_id']); echo$x;?>
                </textarea>
                <h6></h6>
                ...
                <br>
                <button class="btn btn-primary" type="submit" id="publish" name="edit">Edit App</button>
            </div>
        </form>
    </div>
